            ...
            if(response.status_code == 200):
                ...
                while max_tries > 0:
                    if script:
                       ...
                       print("Requesting again with retries remaining: "+str(max_tries))
            else:
                status = response.status_code
                print("response Status_code ="+str(status))
                print(Fore.LIGHTRED_EX+"No User Found Against The UserName Provided Try Other UserName....")
